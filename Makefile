...
$(BUILD_DIR)/$(GOOS)-$(GOARCH)/systemtray: $(BUILD_DIR)/$(GOOS)-$(GOARCH)
	mkdir $(BUILD_DIR)/$(GOOS)-$(GOARCH)/systemtray
...
.PHONY: systemtray
systemtray: clean fmtcheck test with_systemtray

with_systemtray: $(BUILD_DIR)/darwin-amd64/systemtray/minishift $(BUILD_DIR)/windows-amd64/systemtray/minishift.exe
